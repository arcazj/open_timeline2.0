...
**No project license has been selected yet.** Public repository visibility does not grant an open-source license. Bundled dependency/font/Unicode notices are preserved in the standalone file; historical datasets, supplied reference images, and legacy assets require separate provenance and redistribution review. See [third-party notices](docs/third-party-notices.md) and [dataset provenance](data/README.md). Public demo deployment is gated on the owner's approval of these materials.
